/*custom-js*/
document.addEventListener("alpine:init",()=>{Alpine.data("collapse",()=>({collapse:!1,collapseSidebar:function(){this.collapse=!this.collapse}})),Alpine.data("dropdown",(e=!1)=>({open:e,toggle:function(){this.open=!this.open}})),Alpine.data("modals",(e=!1)=>({open:e,toggle:function(){this.open=!this.open}})),Alpine.data("main",e=>({})),Alpine.store("app",{sidebar:!1,toggleSidebar:function(){this.sidebar=!this.sidebar},mode:Alpine.$persist("light"),toggleMode:function(e){e=e||(this.mode||"light"),this.mode=e},toggleFullScreen:function(){document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen()}})});
